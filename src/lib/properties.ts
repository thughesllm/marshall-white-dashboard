...
function transformRow(row: Record<string, string>): Property {
  ...
  const property: Property = {
    ...
    agent2Photo: cleanString(row.agent_2_photo),
    agent3Name: cleanString(row.agent_3_name),
    agent3Email: cleanString(row.agent_3_email),
    agent3Mobile: cleanString(row.agent_3_mobile),
    agent3Phone: cleanString(row.agent_3_phone),
    agent3Position: cleanString(row.agent_3_position),
    agent3Photo: cleanString(row.agent_3_photo),
    agent1Photo: cleanString(row.agent_1_photo),
